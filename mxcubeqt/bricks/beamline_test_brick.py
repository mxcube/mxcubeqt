...
class BeamlineTestBrick(BaseWidget):
    ...
    def property_changed(self, property_name, old_value, new_value):
        ...
        #    self.unittest_hwobj = self.get_hardware_object(new_value)
        else:
    ...
    def test_focus_mode(self):
        ...
        if focus_modes:
            ...
            hor_labels = qt_import.QStringList(focus_modes)
        ...
        if focus_motors_list:
            ver_labels = qt_import.QStringList()
            ...
            for row, motor in enumerate(focus_motors_list):
                ...
                for col, mode in enumerate(focus_modes):
                    ...
                    if res:
                        temp_table_item = qt_import.QTableWidgetItem(item_text)
