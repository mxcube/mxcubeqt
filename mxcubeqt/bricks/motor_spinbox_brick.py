...
class MotorSpinboxBrick(BaseWidget):
    ...
    def __init__(self, *args):
        ...
        self.position_spinbox.setContextMenuPolicy(qt_import.Qt.CustomContextMenu)
        ...
        self.position_slider = qt_import.QDoubleSlider(
            qt_import.Qt.Horizontal, self.main_gbox
        )
    ...
    def set_position_spinbox_color(self, state):
        ...
        colors.set_widget_color(
            self.position_spinbox.lineEdit(), colors.get_state_color(state), qt_import.QPalette.Base
        )
...
class StepEditorDialog(qt_import.QDialog):
