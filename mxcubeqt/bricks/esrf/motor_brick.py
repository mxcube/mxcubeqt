...
class MotorControlDialog(qt_import.QDialog):
    """
    ...
    def __init__(self, parent, title):
        ...
        self.setSizePolicy(qt_import.QSizePolicy.Minimum, qt_import.QSizePolicy.Minimum)

        # Layout --------------------------------------------------------------
        self._dialog_vlayout = qt_import.QVBoxLayout(self)
...
class StepEditor(qt_import.QFrame):
    ...
    def __init__(self, layout, initial_value, parent=None, title="", prefix=""):
        ...
        self.double_validator.setNotation(qt_import.QDoubleValidator.StandardNotation)
        ...
        if layout == StepEditor.RIGHT_LAYOUT:
            self.cmd_select_value = qt_import.QPushButton(prefix + str(initial_value))
...
class MotorSlider(qt_import.QWidget):
...
class MotorBrick(BaseWidget):
    ...
    def __init__(self, *args):
        ...
        self.setSizePolicy(qt_import.QSizePolicy.Minimum, qt_import.QSizePolicy.Fixed)
    ...
    def slot_status(self, state):
        ...
        palette = qt_import.QPalette()
        palette.setColor(qt_import.QPalette.Window, color[state])
...
class DialogButtonsBar(qt_import.QWidget):
    ...
    def __init__(self, parent, button1="OK", button2="Cancel",
        ...
        spacer = qt_import.QWidget(self)
        spacer.setSizePolicy(qt_import.QSizePolicy.Expanding,
                             qt_import.QSizePolicy.Fixed)

        # Layout --------------------------------------------------------------
        self._dialog_vlayout = qt_import.QVBoxLayout(self,margin,spacing)
        self._dialog_vlayout.addWidget(spacer)

        if button1 is not None:
            self.button1 = qt_import.QPushButton(button1, self)
            self._dialog_vlayout.addWidget(self.button1)
            self.button1.clicked.connect(self.button1_clicked)

        if button2 is not None:
            self.button2 = qt_import.QPushButton(button1, self)
            self._dialog_vlayout.addWidget(self.button2)
            self.button2.clicked.connect(self.button2_clicked)

        if button3 is not None:
            self.button3 = qt_import.QPushButton(button1, self)
