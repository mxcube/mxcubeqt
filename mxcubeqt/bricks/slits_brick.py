...
class SlitsBrick(BaseWidget):
    ...
    def __init__(self, *args):
        ...
        self.stop_hor_button = qt_import.QPushButton(
        ...
        self.stop_ver_button = qt_import.QPushButton(
            icons.load_icon("Stop2"), "", self.main_gbox
        )
    ...
    def property_changed(self, property_name, old_value, new_value):
        if property_name == "mnemonic":
            ...
            if self.slitbox_hwobj is not None:
                ...
                self.slitbox_hwobj.force_emit_signals()
            else:
    ...
    def initiate_spinboxes(self):
        ...
        colors.set_widget_color(
            self.hor_pos_dspinbox, SlitsBrick.CONNECTED_COLOR, qt_import.QPalette.Button
        )
        colors.set_widget_color(
            self.ver_pos_dspinbox, SlitsBrick.CONNECTED_COLOR, qt_import.QPalette.Button
        )
