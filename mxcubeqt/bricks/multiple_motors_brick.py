...
class MultipleMotorsBrick(BaseWidget):
    def __init__(self, *args):
        ...
        self.enable_motors_buttons = qt_import.QPushButton("Enable", self.main_group_box)
        ...
        if self["alignment"] == "horizontal":
            self.main_groupbox_hlayout = qt_import.QHBoxLayout(self.main_group_box)
        else:
            self.main_groupbox_hlayout = qt_import.QVBoxLayout(self.main_group_box)
