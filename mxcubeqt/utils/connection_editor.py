...
class ConnectionEditor(qt_import.QDialog):
    """Connection editor"""
    ...
    def __init__(self, configuration):
        ...
        # Graphic elements ----------------------------------------------------
        main_splitter = qt_import.QSplitter(qt_import.Qt.Vertical, self)
        top_panel = qt_import.QWidget(main_splitter)
        bot_panel = qt_import.QWidget(main_splitter)

        emitter_panel = qt_import.QWidget(top_panel)
        self.emitter_windows_listwidget = qt_import.QListWidget(emitter_panel)
        self.emitter_objects_listwidget = qt_import.QListWidget(emitter_panel)
        self.emitter_signals_listwidget = qt_import.QListWidget(emitter_panel)
        self.emitter_objects_listwidget.setSortingEnabled(True)
        self.emitter_signals_listwidget.setSortingEnabled(True)

        receiver_panel = qt_import.QWidget(top_panel)
        self.receiver_windows_listwidget = qt_import.QListWidget(emitter_panel)
        self.receiver_objects_listwidget = qt_import.QListWidget(emitter_panel)
        self.receiver_slots_listwidget = qt_import.QListWidget(emitter_panel)
        self.receiver_objects_listwidget.setSortingEnabled(True)
        self.receiver_slots_listwidget.setSortingEnabled(True)

        self.add_connection_button = qt_import.QPushButton("Add connection", self)

        self.connections_treewidget = qt_import.QTreeWidget(bot_panel)
        button_panel = qt_import.QWidget(bot_panel)
        self.remove_connection_button = qt_import.QPushButton(
            "Remove connection", button_panel
        )
        self.ok_button = qt_import.QPushButton("OK", button_panel)
        self.cancel_button = qt_import.QPushButton("Cancel", button_panel)

        # Layout --------------------------------------------------------------
        emitter_panel_layout = qt_import.QGridLayout(emitter_panel)
        emitter_panel_layout.addWidget(
            qt_import.QLabel("<h3>Emitters</h3>", self), 0, 1, qt_import.Qt.AlignHCenter
        )
        emitter_panel_layout.addWidget(qt_import.QLabel("Windows", self), 1, 0)
        emitter_panel_layout.addWidget(qt_import.QLabel("Objects", self), 1, 1)
        emitter_panel_layout.addWidget(qt_import.QLabel("Signals", self), 1, 2)
        ...
        receiver_panel_layout = qt_import.QGridLayout(receiver_panel)
        receiver_panel_layout.addWidget(
            qt_import.QLabel("<h3>Receivers</h3>", self), 0, 1, qt_import.Qt.AlignHCenter
        )
        receiver_panel_layout.addWidget(qt_import.QLabel("Windows", self), 1, 0)
        receiver_panel_layout.addWidget(qt_import.QLabel("Objects", self), 1, 1)
        receiver_panel_layout.addWidget(qt_import.QLabel("Slots", self), 1, 2)
        ...
        top_panel_layout = qt_import.QHBoxLayout(top_panel)
        ...
        button_panel_layout = qt_import.QHBoxLayout(button_panel)
        button_panel_layout.addWidget(self.remove_connection_button)
        button_panel_layout.addStretch(0)
        button_panel_layout.addWidget(self.ok_button, qt_import.Qt.AlignRight)
        button_panel_layout.addWidget(self.cancel_button, qt_import.Qt.AlignRight)

        bot_panel_vlayout = qt_import.QVBoxLayout(bot_panel)
        bot_panel_vlayout.addWidget(
            qt_import.QLabel("<h3>Established connections</h3>", bot_panel)
        )
        bot_panel_vlayout.addWidget(self.connections_treewidget)
        bot_panel_vlayout.addWidget(button_panel)

        main_splitter_vbox = qt_import.QVBoxLayout(main_splitter)
    ...
    def add_connection_button_clicked(self):
        ...
        if slot_item:
            ...
            qt_import.QMessageBox.warning(self, "Cannot add connection", "Missing slot.")
            return
    ...
    def add_pending_connection(self, connection_dict):
        ...
        new_item = qt_import.QTreeWidgetItem(self.connections_treewidget, parameter_list)
        new_item.setIcon(0, icons.load_icon("button_ok_small"))
