...
from mxcubeqt.widgets.reference_image_widget import ReferenceImageWidget
from mxcubeqt.widgets.char_type_widget import CharTypeWidget
from mxcubeqt.widgets.optimisation_parameters_widget_layout import (
