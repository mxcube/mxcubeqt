...
dcg_id = server.native_json_add_child(1, json_dcg)
...
es_id = server.native_json_add_child(dcg_id, json_es)
...
energy_scan = jsonpickle.decode(server.native_json_get_node(es_id))
...
for energy in energies:
    ...
    dc_id = server.native_json_add_child(dcg_id, dc)
