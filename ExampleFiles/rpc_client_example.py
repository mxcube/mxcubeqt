...
server = xmlrpclib.ServerProxy('http://linoscarsson:8000')
...
dcg_id = server.model_add_child(1, json_dcg)
...
es_id = server.model_add_child(dcg_id, json_es)
...
energy_scan = jsonpickle.decode(server.model_get_node(es_id))
...
for energy in energies:
    ...
    dc_id = server.model_add_child(dcg_id, dc)
