Example Files
=============
Example configuration files for framework-2 hardware objects. These
...
.. hlist::
   ...
   * :download:`resolution_mockup.xml <../../../ExampleFiles/HardwareObjects.xml/resolution-mockup.xml>`
