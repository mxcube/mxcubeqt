...
class AcquisitionWidget(QtImport.QWidget):
    ...
    def set_beamline_setup(self, beamline_setup):
        ...
        num_passes = self.acq_widget_layout.findChild(QtImport.QLineEdit, "num_passes_ledit")

        if num_passes:
            self._acquisition_mib.\
                bind_value_update('num_passes', num_passes, int,
                                  QtImport.QIntValidator(1, 1000, self))

        overlap_ledit = self.acq_widget_layout.findChild(QtImport.QLineEdit, "overlap_ledit")
