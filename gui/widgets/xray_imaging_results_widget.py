...
class XrayImagingResultsWidget(QtImport.QWidget):
    ...
    def __init__(self, parent=None, name=None, fl=0, xray_imaging_params=None):
        ...
        self.start_centering_button = QtImport.QPushButton("Start centering", tools_gbox)
        self.accept_centering_button = QtImport.QPushButton("Create centering point", tools_gbox)         

        # Layout --------------------------------------------------------------
        self._graphics_view_widget_vlayout = QtImport.QVBoxLayout(self.graphics_view_widget)
        ...
        self.live_view_cbox.stateChanged.connect(\
            self.live_view_state_changed)
        ...
        self._results_widget.last_image_button.setIcon(Icons.load_icon("VCRFastForward2"))
    ...
    def populate_widget(self, item):
        ...
        if imaging_params.ff_pre or imaging_params.ff_post:
            ff_file_path = os.path.join(path_template.directory,
                                        "ff_" + path_template.get_image_file_name() % 1)
    ...
    def play_button_clicked(self):
        self.xray_imaging_hwobj.play_images(repeat=self._results_widget.repeat_cbox.isChecked())
