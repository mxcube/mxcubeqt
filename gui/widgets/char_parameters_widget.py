...
from gui.widgets.optimisation_parameters_widget_layout\
    import OptimisationParametersWidgetLayout
from gui.widgets.radiation_damage_model_widget_layout\
    import RadiationDamageModelWidgetLayout
from gui.widgets.vertical_crystal_dimension_widget_layout\
...
class CharParametersWidget(QtImport.QWidget):
    ...
    def populate_parameter_widget(self, tree_view_item):
        ...
        if self._data_collection.acquisitions[0].acquisition_parameters.\
            ...
            image = image.scaled(400, 400 * ration, QtImport.Qt.KeepAspectRatio,
