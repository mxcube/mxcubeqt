...
class ConfirmDialog(QtImport.QDialog):
    ...
    def __init__(self, parent=None, name=None, flags=0):
        ...
        QtImport.QDialog.__init__(self, parent, QtImport.Qt.WindowFlags(flags | QtImport.Qt.WindowStaysOnTopHint))
        ...
        # Graphic elements ---------------------------------------------------- 
        self.conf_dialog_layout = QtImport.load_ui_file(
            ...
            if isinstance(item, queue_item.SampleQueueItem):
                ...
                for col in range(13):
                    sample_treewidget_item.setBackground(col, \
                      QtImport.QBrush(Colors.TREE_ITEM_SAMPLE))
            ...
            if acq_parameters and path_template:
                ...
                for col in range(13):
                    collection_treewidget_item.setBackground(col, \
                      QtImport.QBrush(Colors.TREE_ITEM_COLLECTION))  
