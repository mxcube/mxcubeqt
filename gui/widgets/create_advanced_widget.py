...
class CreateAdvancedWidget(CreateTaskBase):
    ...
    def __init__(self, parent=None,name=None, fl=0):
        CreateTaskBase.__init__(self, parent, name, 
            QtImport.Qt.WindowFlags(fl), 'Advanced')
    ...
    def single_item_selection(self, tree_item):
        ...
        elif isinstance(tree_item, queue_item.DataCollectionQueueItem) or \
             isinstance(tree_item, queue_item.XrayCenteringQueueItem):
