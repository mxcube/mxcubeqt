...
class MotorSpinBoxBrick(BaseWidget):
    ...
    def __init__(self, *args):
        ...
        self.step_combo.setValidator(QtImport.QDoubleValidator(0, 360, 5, self.step_combo))
        self.step_combo.setDuplicatesEnabled(False)
        self.step_combo.setFixedHeight(27) 
        
        self.position_slider = QtImport.QDoubleSlider(QtImport.Qt.Horizontal, self.main_gbox)
    ...
    def step_edited(self, step):
        Colors.set_widget_color(self.step_combo.lineEdit(),
    ...
    def set_position_spinbox_color(self, state):
        ...
        Colors.set_widget_color(self.position_spinbox.lineEdit(), 
                                       color,
...
class StepEditorDialog(QtImport.QDialog):
    ...
    def __init__(self, parent):
        ...
        # SizePolicies --------------------------------------------------------
        self.close_button.setSizePolicy(QtImport.QSizePolicy.Fixed,
