...
class ConnectionEditor(QtImport.QDialog):
    ...
    def __init__(self, configuration):
        ...
        emitter_panel_layout.addWidget(QtImport.QLabel('<h3>Emitters</h3>', self),
                                       0, 1, QtImport.Qt.AlignHCenter)
        ...
        bot_panel_vlayout.addWidget(QtImport.QLabel('<h3>Established connections</h3>', bot_panel))
        ...
        self.cancel_button.setSizePolicy(QtImport.QSizePolicy.Fixed,
                                         QtImport.QSizePolicy.Fixed)
        self.connections_treewidget.setSizePolicy(QtImport.QSizePolicy.Expanding,
    ...
    def add_connection_button_clicked(self):
        ...
        if sender_window_item:
            ...
            QtImport.QMessageBox.warning(self, 'Cannot add connection',
