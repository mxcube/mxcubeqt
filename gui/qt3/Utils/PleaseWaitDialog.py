...
def show(msg="Please wait...", abortMsg="abort", abortCallback=None):
    ...
    _pleaseWaitDialog = QWidget(
        None,
        "",
        Qt.WStyle_Customize | Qt.WShowModal | Qt.WStyle_Splash | Qt.WDestructiveClose,
    )
    ...
    _pleaseWaitDialog.move(
        (sw - _pleaseWaitDialog.width()) / 2, (sh - _pleaseWaitDialog.height()) / 2
    )
