...
class MotorPredefPosBrick(
    MotorWPredefinedPositionsBrick.MotorWPredefinedPositionsBrick
):
    ...
    def __init__(self, *args):
        MotorWPredefinedPositionsBrick.MotorWPredefinedPositionsBrick.__init__(
            self, *args
        )
    ...
    def motorStateChanged(self, state):
        ...
        MotorWPredefinedPositionsBrick.MotorWPredefinedPositionsBrick.motorStateChanged(
            self, state
        )
    ...
    def propertyChanged(self, propertyName, oldValue, newValue):
        if propertyName == "label":
            ...
            MotorWPredefinedPositionsBrick.MotorWPredefinedPositionsBrick.propertyChanged(
            ...
            if self.motor is None:
                self.lstPositions.setPaletteBackgroundColor(
    ...
    def setMnemonic(self, mne):
        MotorWPredefinedPositionsBrick.MotorWPredefinedPositionsBrick.setMnemonic(
            self, mne
        )
