...
class CreateHelicalWidget(CreateTaskBase):
    def __init__(self, parent=None, name=None, fl=0):
        ...
        add_button_tool_tip = (
            "Add a line between two saved positions, "
        ...
        qt.QObject.connect(add_button, qt.SIGNAL("clicked()"), self.add_clicked)
    ...
    def add_clicked(self):
        ...
        if len(selected_shapes) == 2:
            ...
            line = shape_history.Line(
                self._shape_history.get_drawing(),
                p1.qub_point,
                p2.qub_point,
                p1.centred_position,
                p2.centred_position,
    ...
    def select_shape_with_cpos(self, start_cpos, end_cpos):
        ...
        for shape in self._shape_history.get_shapes():
            if isinstance(shape, shape_history.Line):
                if (
                    shape.get_centred_positions()[0] == start_cpos
                    and shape.get_centred_positions()[1] == end_cpos
                ):
    ...
    def _create_task(self, sample, shape):
        ...
        if isinstance(shape, shape_history.Line):
            ...
            end_acq.acquisition_parameters.centred_position = shape.end_cpos
