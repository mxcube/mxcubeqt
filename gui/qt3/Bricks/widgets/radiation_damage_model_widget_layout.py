...
class RadiationDamageModelWidgetLayout(QWidget):
    def __init__(self, parent=None, name=None, fl=0):
        ...
        RadiationDamageModelWidgetLayoutLayout = QVBoxLayout(
            self, 0, 0, "RadiationDamageModelWidgetLayoutLayout"
        )
    ...
    def __trUtf8(self, s, c=None):
        return qApp.translate(
            "RadiationDamageModelWidgetLayout", s, c, QApplication.UnicodeUTF8
        )
