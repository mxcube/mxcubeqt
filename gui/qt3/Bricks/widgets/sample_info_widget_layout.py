...
class SampleInfoWidgetLayout(QWidget):
    def __init__(self, parent=None, name=None, fl=0):
        ...
        SampleInfoWidgetLayoutLayout = QVBoxLayout(
            self, 0, 0, "SampleInfoWidgetLayoutLayout"
        )
        ...
        self.basket_location_value_label = QLabel(
            self.gbox, "basket_location_value_label"
        )
        ...
        self.sample_location_value_label = QLabel(
            self.gbox, "sample_location_value_label"
        )
