...
class SelectionTable(qttable.QTable):
    ...
    def get_value(self):
        ...
        return [self.cellWidget(row_id, ii).text() for ii in range(self.numCols())]
...
class GphlDataDialog(qt.QDialog):
    def __init__(self, parent=None, name=None, fl=0):
        ...
        qt.QObject.connect(
            self.cancel_button, qt.SIGNAL("clicked()"), self.cancel_button_click
        )
