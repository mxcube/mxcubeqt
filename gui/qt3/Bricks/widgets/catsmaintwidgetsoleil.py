...
class CatsMaintWidgetSoleil(QWidget):
    def __init__(self, parent=None, name=None, fl=0):
        ...
        CatsMaintWidgetSoleilLayout = QVBoxLayout(
            self, 11, 6, "CatsMaintWidgetSoleilLayout"
        )
        ...
        self.btHome.setSizePolicy(
            QSizePolicy(
                QSizePolicy.Minimum,
                QSizePolicy.Fixed,
                0,
                0,
                self.btHome.sizePolicy().hasHeightForWidth(),
            )
        )
        ...
        self.btDry.setSizePolicy(
            QSizePolicy(
                QSizePolicy.Minimum,
                QSizePolicy.Fixed,
                0,
                0,
                self.btDry.sizePolicy().hasHeightForWidth(),
            )
        )
        ...
        self.btSoak.setSizePolicy(
            QSizePolicy(
                QSizePolicy.Minimum,
                QSizePolicy.Fixed,
                0,
                0,
                self.btSoak.sizePolicy().hasHeightForWidth(),
            )
        )
        ...
        self.btMemoryClear.setSizePolicy(
            QSizePolicy(
                QSizePolicy.Minimum,
                QSizePolicy.Fixed,
                0,
                0,
                self.btMemoryClear.sizePolicy().hasHeightForWidth(),
            )
        )
        ...
        self.btToolOpen.setSizePolicy(
            QSizePolicy(
                QSizePolicy.Minimum,
                QSizePolicy.Fixed,
                0,
                0,
                self.btToolOpen.sizePolicy().hasHeightForWidth(),
            )
        )
        ...
        self.btToolcal.setSizePolicy(
            QSizePolicy(
                QSizePolicy.Minimum,
                QSizePolicy.Fixed,
                0,
                0,
                self.btToolcal.sizePolicy().hasHeightForWidth(),
            )
        )
    ...
    def languageChange(self):
        ...
        # MS 2015-03-25 replacing Clear Memory by Missing Sample
        self.btMemoryClear.setText(self.__tr("Missing Sample"))
