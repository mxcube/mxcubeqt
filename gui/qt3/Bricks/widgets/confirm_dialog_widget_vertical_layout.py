...
class ConfirmDialogWidgetVerticalLayout(QWidget):
    def __init__(self, parent=None, name=None, fl=0):
        ...
        ConfirmDialogWidgetVerticalLayoutLayout = QHBoxLayout(
            self, 11, 6, "ConfirmDialogWidgetVerticalLayoutLayout"
        )
        ...
        self.skip_existing_images_cbx = QCheckBox(
            self.summary_gbox, "skip_existing_images_cbx"
        )
        ...
        take_snapshots_hspacer = QSpacerItem(
        ...
        self.file_list_view.header().setClickEnabled(
            0, self.file_list_view.header().count() - 1
        )
        ...
        self.file_list_view.setSizePolicy(
            QSizePolicy(
                ...
                0,
                0,
                self.file_list_view.sizePolicy().hasHeightForWidth(),
            )
        )
    ...
    def languageChange(self):
        ...
        self.skip_existing_images_cbx.setText(
            self.__tr("Skip already collected images")
        )
