...
class GridDialog(qt.QDialog):
    def __init__(
        ...
        qt.QObject.connect(
            widget.child("add_button"), qt.SIGNAL("clicked()"), self.__add_drawing
        )

        qt.QObject.connect(
            widget.child("remove_button"), qt.SIGNAL("clicked()"), self.__delete_drawing
        )
    ...
    def set_beam_position(self, beam_c_x, beam_c_y, beam_width_mm, beam_height_mm):
        ...
        try:
            ...
            self.__drawing_mgr.set_beam_position(
                beam_c_x, beam_c_y, beam_width_mm, beam_height_mm
            )
