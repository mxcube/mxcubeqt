...
class FeedbackBrick(BaseComponents.BlissWidget):
    ...
    def submitMessage(self):
        ...
        try:
            ...
            subj = "[BEAMLINE FEEDBACK] %s on %s (%s)" % (
                prop_str,
                frombl,
                BlissFramework.loggingName,
            )
            email_msg = "From: %s\r\nTo: %s\r\nSubject: %s\r\nDate: %s\r\n\r\n%s" % (
                fromaddr,
                toaddrs,
            ...
            if self["jira_server"]:
                ...
                jira_customfield = [
                    {"customfieldId": "customfield_10794", "values": ["No"]},
                    {"customfieldId": "customfield_11290", "values": ["No"]},
                ]
                data = {
                    "project": self["jira_project"],
                    "customFieldValues": jira_customfield,
                    "type": 5,
                    "summary": subj,
