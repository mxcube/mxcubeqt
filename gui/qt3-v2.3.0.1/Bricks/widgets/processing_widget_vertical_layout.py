...
class ProcessingWidgetVerticalLayout(QWidget):
    def __init__(self, parent=None, name=None, fl=0):
        ...
        ProcessingWidgetVerticalLayoutLayout = QHBoxLayout(
            self, 0, 0, "ProcessingWidgetVerticalLayoutLayout"
        )
        ...
        pdb_heading_spacer = QSpacerItem(
            1, 20, QSizePolicy.Expanding, QSizePolicy.Minimum
        )
    ...
    def __trUtf8(self, s, c=None):
        return qApp.translate(
            "ProcessingWidgetVerticalLayout", s, c, QApplication.UnicodeUTF8
        )
