...
class NamedStateBrick(BaseComponents.BlissWidget):
    ...
    def __init__(self, *args):
        ...
        #
        QObject.connect(self.lstStates, SIGNAL('activated( int )'), self.lstStatesClicked)
    ...
    def stateChanged(self, state):
        if not self.lstStates:
            ...
            for i in range(len(self.states)):
                ...
                logging.debug("   - could not find %s in list of valid states (%s)" % (state, str(self.states)))
