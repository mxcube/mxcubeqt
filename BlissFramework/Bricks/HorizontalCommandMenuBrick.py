...
class HorizontalCommandMenuBrick(BlissWidget):
    ...
    def propertyChanged(self, property, oldValue, newValue):
        if property == 'mnemonic':
            ...
            if self.safetyShutter is None:
                logging.getLogger().warning("HorizontalCommandMenuBrick: safety shutter not configured")
        elif property == 'icons':
    ...
    def setIcons(self,icons):
        ...
        try:
            ...
            stop_icon_name=HorizontalCommandMenuBrick.STOP_COMMAND_ICON
        try:
            cancel_icon_name=stop_cancel_icons[1]
        except IndexError:
            cancel_icon_name=HorizontalCommandMenuBrick.CANCEL_COMMAND_ICON
