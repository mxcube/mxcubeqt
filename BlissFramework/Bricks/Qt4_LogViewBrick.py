            ...
            if new_value == "list":
                ...
                for l in Qt4_LogViewBrick.LOGS:
                    if l == "debug" and not self['showDebug']:
                        ...
                        exec("self.tab_widget.addTab(self.%s_log,'%s')" % (l, Qt4_LogViewBrick.TITLES[l]))
                        exec("self.tab_widget.setTabToolTip(self.tab_widget.indexOf(self.%s_log),'%s')" % (l, Qt4_LogViewBrick.TOOLTIPS[l]))
