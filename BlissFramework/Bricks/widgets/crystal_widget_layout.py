...
class CrystalWidgetLayout(QWidget):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        self.amino_acid_residiues_label = QLabel(self.gbox,"amino_acid_residiues_label")
        ...
        self.protein_acronym_value_label = QLabel(self.gbox,"protein_acronym_value_label")
        ...
        self.monomers_asym_unit_value_label = QLabel(self.gbox,"monomers_asym_unit_value_label")
        rone_value_layout.addWidget(self.monomers_asym_unit_value_label)

        self.amino_acid_residiues_value_label = QLabel(self.gbox,"amino_acid_residiues_value_label")
        rone_value_layout.addWidget(self.amino_acid_residiues_value_label)

        self.dna_nucleotides_value_label = QLabel(self.gbox,"dna_nucleotides_value_label")
        rone_value_layout.addWidget(self.dna_nucleotides_value_label)

        self.rna_nucleotides_value_label = QLabel(self.gbox,"rna_nucleotides_value_label")
        ...
        unit_cell_layout = QSpacerItem(16,20,QSizePolicy.Expanding,QSizePolicy.Minimum)
    ...
    def languageChange(self):
        ...
        self.amino_acid_residiues_label.setText(self.__tr("Amino acid residiues per monomer:"))
