...
class SADWidgetLayout(QtGui.QWidget):
    """
    Descript. :
    """
    ...
    def __init__(self, parent = None, name = None, flags = 0):
        ...
        # Graphic elements ----------------------------------------------------
        self.optimised_sad_cbx = QtGui.QCheckBox(self)
        self.automatic_resolution_radio = QtGui.QRadioButton(self)
        _optimal_sad_widget = QtGui.QWidget(self)
        self.optimal_sad_radio = QtGui.QRadioButton(_optimal_sad_widget)
        self.sad_bgroup = QtGui.QButtonGroup(self)
        self.sad_bgroup.addButton(self.automatic_resolution_radio) 
        self.sad_bgroup.addButton(self.optimal_sad_radio)
        self.sad_resolution_ledit = QtGui.QLineEdit(_optimal_sad_widget)
        self.sad_resolution_ledit.setMinimumSize(QtCore.QSize(50,0))
        self.sad_resolution_ledit.setMaximumSize(QtCore.QSize(50,32767))

        # Layout --------------------------------------------------------------
        _optimal_sad_widget_hlayout = QtGui.QHBoxLayout(self)
    ...
    def __tr(self, s, c = None):
        ...
        Descript. :
        """
        return QtGui.QApplication.translate("SADWidgetLayout", s, c)

    def __trUtf8(self, s, c = None):
        """
        Descript. :
        """
        return QtGui.QApplication.translate("SADWidgetLayout", s, c, QtGui.QApplication.UnicodeUTF8)
