...
disable:function(){if(H){l.stopTime("blink",k);E.removeClass("inverted");H=false}},mask:function(e){if(typeof e==="boolean"){J=e;G()}else return J}});l.name(d.name||"");B=d.prompt||"> ";N();if(d.enabled===K||d.enabled===true)l.enable();g(document.documentElement||window).keypress(function(e){var h;if(!x&&typeof d.keypress==="function")h=d.keypress(e);if(h===K||h){if(H)if(g.inArray(e.which,[38,32,13,0,8])>-1&&e.keyCode!==123&&!(e.which===38&&e.shiftKey))return false;
