    ...
    def propertyChanged(self, propertyName, oldValue, newValue):
        ...
        if propertyName == "EDNA_conf":
            if self.ednaObj is not None:
                self.disconnect(self.ednaObj,PYSIGNAL("strategyDictCreated"),self.createStrategyDict)
            self.ednaObj=self.getHardwareObject(newValue)
            if self.ednaObj is not None:
                self.connect(self.ednaObj,PYSIGNAL("strategyDictCreated"),self.createStrategyDict)                
