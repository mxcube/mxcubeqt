...
class VerticalCrystalDimensionWidgetLayout(QWidget):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        self.gbox.setSizePolicy(QSizePolicy(QSizePolicy.MinimumExpanding,QSizePolicy.MinimumExpanding,0,0,self.gbox.sizePolicy().hasHeightForWidth()))
    ...
    def __trUtf8(self,s,c = None):
        return qApp.translate("VerticalCrystalDimensionWidgetLayout",s,c,QApplication.UnicodeUTF8)
