...
class DiffractionPlanWidgetLayout(QWidget):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        DiffractionPlanWidgetLayoutLayout = QHBoxLayout(self,11,6,"DiffractionPlanWidgetLayoutLayout")
        ...
        self.space_group_ledit = QLineEdit(self.diffraction_plan_gb,"space_group_ledit")
        ...
        self.max_exp_time_ledit = QLineEdit(self.diffraction_plan_gb,"max_exp_time_ledit")
        ...
        self.complexity_ledit = QComboBox(0,self.diffraction_plan_gb,"complexity_ledit")
    ...
    def languageChange(self):
        ...
        self.aimed_res_label.setText(self.__tr("Aimed resolution (default - highest possible):"))
        self.aimed_mult_label.setText(self.__tr("Aimed multiplicity (default - optimized):"))
        self.aimed_ios_label.setText(self.__tr("Aimed I over Sigma at highest resolution:"))
        self.aimed_comp_label.setText(self.__tr("Aimed completeness (default >= 0.99):"))
