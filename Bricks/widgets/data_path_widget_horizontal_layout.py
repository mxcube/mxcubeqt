...
class DataPathWidgetHorizontalLayout(QWidget):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        DataPathWidgetHorizontalLayoutLayout = QHBoxLayout(self,0,0,"DataPathWidgetHorizontalLayoutLayout")
        ...
        file_name_hspacer = QSpacerItem(61,20,QSizePolicy.Expanding,QSizePolicy.Minimum)
        ...
        run_number_spacer = QSpacerItem(1,20,QSizePolicy.Expanding,QSizePolicy.Minimum)
