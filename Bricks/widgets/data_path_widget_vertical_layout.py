...
class DataPathWidgetVerticalLayout(QWidget):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        DataPathWidgetVerticalLayoutLayout = QHBoxLayout(self,0,0,"DataPathWidgetVerticalLayoutLayout")
        ...
        file_name_hspacer = QSpacerItem(1,20,QSizePolicy.Expanding,QSizePolicy.Minimum)
