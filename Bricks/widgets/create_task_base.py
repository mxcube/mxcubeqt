...
class CreateTaskBase(qt.QWidget):
    ...
    def init_acq_model(self):
        ...
        if bl_setup is not None:
            if self._acq_widget:
                ...
                #TODO suggestion to use various default parameters for helical, characterisation...
                self._acquisition_parameters = bl_setup.\
    ...
    def set_beamline_setup(self, bl_setup_hwobj):
        ...
        try:
            ...
            if bl_setup_hwobj.energy_hwobj is not None:
