...
class OptimisationParametersWidgetLayout(QWidget):
    def __init__(self,parent = None,name = None,fl = 0):
        ...
        OptimisationParametersWidgetLayoutLayout = QVBoxLayout(self,0,0,"OptimisationParametersWidgetLayoutLayout")
        ...
        self.aimed_i_over_sigma_label.setSizePolicy(QSizePolicy(QSizePolicy.Fixed,QSizePolicy.Preferred,0,0,self.aimed_i_over_sigma_label.sizePolicy().hasHeightForWidth()))
    ...
    def languageChange(self):
        ...
        self.aimed_i_over_sigma_label.setText(self.__trUtf8("\x41\x69\x6d\x65\x64\x20\x49\x2f\xcf\x83\x20\x61\x74\x20\x68\x69\x67\x68\x65\x73\x74\x20\x72\x65\x73\x6f\x6c\x75\x74\x69\x6f\x6e\x3a"))
        ...
        self.phi_start_label.setText(self.__trUtf8("\xcf\x89\x2d\x73\x74\x61\x72\x74\x3a"))
        self.phi_end_label.setText(self.__trUtf8("\xcf\x89\x2d\x65\x6e\x64\x3a"))
        self.low_res_pass_cbx.setText(self.__tr("Calculate low resolution pass strategy"))
    ...
    def __trUtf8(self,s,c = None):
        return qApp.translate("OptimisationParametersWidgetLayout",s,c,QApplication.UnicodeUTF8)
