...
class Qt4_Soleil_MotorSpinBoxBrick(BlissWidget):
    """
    Descript. :
    """
    ...
    def __init__(self, *args):
        ...
        self.step_cbox = QComboBox(self.extra_button_box)
    ...
    def update_history(self, pos):
        ...
        if pos not in self.pos_history:
            if len(self.pos_history) == Qt4_Soleil_MotorSpinBoxBrick.MAX_HISTORY:
    ...
    def set_position_spinbox_color(self, state):
        ...
        Return.   : 
        """
        color = Qt4_Soleil_MotorSpinBoxBrick.STATE_COLORS[state]
    ...
    def set_motor(self, motor, motor_ho_name = None):
        ...
        if self.motor_hwobj is not None:
            ...
            self.connect(self.motor_hwobj, 'positionChanged', self.position_changed, instanceFilter = True)
            self.connect(self.motor_hwobj, 'stateChanged', self.state_changed, instanceFilter=True)
...
class StepEditorDialog( QDialog):
    ...
    def __init__(self, parent):
        ...
        # Graphic elements-----------------------------------------------------
        #self.main_gbox = QGroupBox('Motor step', self)
        #box2 = QWidget(self)
