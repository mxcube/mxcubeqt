...
from widgets.task_toolbox_widget_px2 import TaskToolBoxWidget
...
class TaskToolBoxBrickPX2(BaseComponents.BlissWidget):
    ...
    def run(self):
        ...
        self.task_tool_box_widget.grid_scan_page._grid_widget._setColor(qt.QWidget.green)
        self.task_tool_box_widget.grid_scan_page.\
